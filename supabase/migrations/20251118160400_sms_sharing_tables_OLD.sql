...
-- (Includes playlists from SMS shares after account creation)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS playlist_followers (
  ...
  -- Track how user started following
  source TEXT DEFAULT 'manual' CHECK (source IN ('manual', 'sms_share', 'band_member')),
